#!/usr/bin/env python3
"""Complete empty VisText label JSON files using evaluation data splits."""
...
LABELS_DIR = REPO_ROOT / "VisText" / "Data" / "labels"
TRAIN_FILE = EVALUATION_DIR / "data_train.json"
VALIDATION_FILE = EVALUATION_DIR / "data_validation.json"
TEST_FILE = EVALUATION_DIR / "data_test.json"


def load_train_data(train_file: Path) -> Dict[str, Any]:
...
def find_empty_json_files(labels_dir: Path) -> List[str]:
