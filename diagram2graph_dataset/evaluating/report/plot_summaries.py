...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--node-sep-few",
        type=Path,
        default=f1_dir / "node_edge_separately" / "fewshot_outputs_node_edge_separate.csv",
        help="Few-shot node/edge separate CSV.",
    )
    parser.add_argument(
        "--node-sep-one",
        type=Path,
        default=f1_dir / "node_edge_separately" / "oneshot_outputs_node_edge_separate.csv",
        help="One-shot node/edge separate CSV.",
    )
    parser.add_argument(
        "--node-sep-zero",
        type=Path,
        default=f1_dir / "node_edge_separately" / "zeroshot_outputs_node_edge_separate.csv",
