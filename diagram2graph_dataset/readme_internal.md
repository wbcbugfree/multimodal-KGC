...
- Use `diagram2graph_dataset/json2ttl/script.py` and `diagram2graph_dataset/evaluating/report/plot_summaries.py` as the reusable script entry points.
...
- Treat `diagram2graph_dataset/extract_rdf_json/`, `diagram2graph_dataset/prompt_engineering/evaluation/`, and `diagram2graph_dataset/evaluating/report/plot_summaries_claude.py` as legacy or staging areas pending later cleanup.
