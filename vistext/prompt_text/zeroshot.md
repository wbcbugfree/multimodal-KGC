...
- If the bar chart is clearly a ranked top/bottom list, order data points by **descending numeric value**.
- Otherwise:
  - use left-to-right order for vertical bars
  - use top-to-bottom order for horizontal bars
