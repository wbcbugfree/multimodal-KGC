...
### Line charts
- Do **not** infer the number of data points only from visible bends, corners, or local shape changes in the plotted line.
- The plotted line is continuous in appearance, but the underlying dataset is discrete.
...
When the x-axis represents yearly observations in a **line chart**:
