...
def build_parser(
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Dynamic one-shot only: batch the chart-type classification step before "
    ...
    return [
        {
            ...
            "example_prompt": build_example_user_prompt(example.chart_type),
...
def run_batch_submit(
    ...
    def ensure_context_cache(prompt_package: PromptPackage) -> dict[str, Any] | None:
        ...
        display_name = (
            f"{config.batch_display_name or 'vistext-batch'}-"
