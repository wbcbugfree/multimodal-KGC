...
OUTPUT_DIR = SCRIPT_DIR / "oneshot_static"
SYSTEM_PROMPT_PATH = PROMPT_ROOT / "zeroshot_system.md"
DESCRIPTION = "Call Gemini on soil-health images with the static table one-shot prompt and save only valid Turtle outputs."


def build_prompt_package(_: Path, __: object | None = None) -> PromptPackage:
    return PromptPackage(
        system_prompt=load_text(SYSTEM_PROMPT_PATH),
        examples=[ground_truth_example("table")],
    )
