...
OUTPUT_DIR = SCRIPT_DIR / "oneshot_outputs"
SYSTEM_PROMPT_PATH = PROMPT_ROOT / "zeroshot_system.md"
DESCRIPTION = "Call Gemini on Diagram2Graph images with static one-shot prompting and save only valid Turtle outputs."
